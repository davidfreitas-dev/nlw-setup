...
export function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <div className="flex flex-col gap-2 mt-3">
        {availaleWeekDays.map((weekDay, index) => {
          return (
            <Checkbox.Root 
              key={weekDay} 
              className="flex items-center gap-3 group p-0 focus:outline-none border-none" 
      ...
      <button 
        type="submit" 
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-black bg-green-600 hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
